<?php
/*
	dsu_paulsign Import By DSU[DSU Team] 2013-07-30
*/
...
EOT;
		...
		showtableheader('Emotion Custom By [CAOGEN8]Shy9000');
		...
		C::t('#dsu_paulsign#dsu_paulsignemot')->delete($_GET['delete']);
		if(is_array($_GET['qdxq'])) {
			foreach($_GET['qdxq'] as $id => $val) {
				C::t('#dsu_paulsign#dsu_paulsignemot')->update($id,array('displayorder' => $_GET['displayorder'][$id], 'qdxq' => $_GET['qdxq'][$id], 'name' => $_GET['name'][$id]));
			}
		}
