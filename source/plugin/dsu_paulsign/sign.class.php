<?php
/*
	dsu_paulsign Echo By DSU 2011-07-15
*/
			...
			if(!$signtime){
				...
				if($qiandaodb){
					...
					if($qiandaodb['time'] < $tdtime){
						if($var['timeopen']) {
							if(!($htime < $var['stime']) && !($htime > $var['ftime'])) return '<span class="pipe">|</span><a href="javascript:;" onclick="showWindow(\'dsu_paulsign\', \'plugin.php?id=dsu_paulsign:sign&'.FORMHASH.'\')" style="color:red;">'.lang('plugin/dsu_paulsign','encore_01').'</a> ';
						}else{
