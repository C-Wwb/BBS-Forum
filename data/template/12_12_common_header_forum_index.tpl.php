...
0
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_common.htm', 1501763010, '12', './data/template/12_12_common_header_forum_index.tpl.php', './template/xinrui_iuni', 'common/header_forum_index')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_qmenu.htm', 1501763010, '12', './data/template/12_12_common_header_forum_index.tpl.php', './template/xinrui_iuni', 'common/header_forum_index')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/xinrui_iuni/common/pubsearchform.htm', 1501763010, '12', './data/template/12_12_common_header_forum_index.tpl.php', './template/xinrui_iuni', 'common/header_forum_index')
;?>
...
<div class="y useBar"><?php include template('common/header_userstatus'); ?> 
<?php if(check_diy_perm($topic)) { ?><div class="y"><?php echo $diynav;?></div><?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">切换风格</a><?php } ?>
