...
<li class="qq"><a href="http://wpa.qq.com/msgrd?v=3&amp;uin=123456789&amp;site=qq&amp;menu=yes">在线客服</a></li>
...
<div id="frt">   
    ...
    <p>新锐创想是一个融创意、设计、技术开发、服务为核心的新锐互联网公司，专注于Discuz!周边插件开发和精品模板设计，坚持为客户打造高品质的精品模板和插件。</p>
    
<p class="xs0 mtm">技术支持： <a href="<?php echo $_G['style']['网址'];?>" target= "_blank"><?php echo $_G['style']['技术支持'];?></a>&nbsp;  <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://w.jiale9.com" target="_blank">Licensed</a><?php } ?>
<span>&copy; 2013-2017 <a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a></span></p>
</div>
</div>
<div class="xr_ft">
 <p>
...
<!-- 加田小店 http://bbwuyu.taobao.com --><?php updatesession();?><?php if($_G['uid'] && $_G['group']['allowinvisible']) { ?>
<script type="text/javascript">
